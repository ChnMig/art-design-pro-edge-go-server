...
func GetMenuAuth(auth *SystemMenuAuth) error {
	if err := postgres.GetClient().Where(auth).First(auth).Error; err != nil {
...
func DeleteMenuAuth(menuAuth *SystemMenuAuth) error {
	if err := postgres.GetClient().Delete(&menuAuth).Error; err != nil {
...
func AddMenuAuth(menuAuth *SystemMenuAuth) error {
	if err := postgres.GetClient().Create(&menuAuth).Error; err != nil {
...
func UpdateMenuAuth(menuAuth *SystemMenuAuth) error {
	if err := postgres.GetClient().Updates(&menuAuth).Error; err != nil {
...
func FindMenuAuthList(menuAuth *SystemMenuAuth) ([]SystemMenuAuth, error) {
	...
	if err := postgres.GetClient().Where(menuAuth).Find(&auths).Error; err != nil {
